...
function ajax_poll_vote(t) {
    var e, i = "",
        n = t.vote.length;
    for (e = 0; n > e; e++) t.vote[e].checked && (i = t.vote[e].value);
...
function in_viewport(t) {
    var e = $(t).viewportOffset(),
        ...
        n = e.top,
        o = e.top + i.height;
    return !(0 > o || n > document.viewport.getHeight())
}
...
function showbasketinfo(t, e, i) {
    e = "undefined" == typeof e ? !1 : e, $j("#basketnavicon, #basketnavicon-wrb").addClass("notempty"), $j("#basket_adder2").remove();
    var n = null,
        o = !0,
        s = !1;
    ...
    function(t, e) {
        ...
        function n(e) {
            ...
            return e = e.toLowerCase(), p(l, function(t, o) {
                var s, r = o.re.exec(e),
                    a = r && o.parse(r),
                    l = o.space || "rgba";
                return a ? (s = i[l](a), i[c[l].cache] = s[c[l].cache], n = i._rgba = s._rgba, !1) : void 0
        ...
        f.style.cssText = "background-color:rgba(1,1,1,.5)", h.rgba = f.style.backgroundColor.indexOf("rgba") > -1, p(c, function(t, e) {
            ...
            var e, i, n = t[0] / 255,
                ...
                c = a + l,
                d = .5 * c;
            return e = l === a ? 0 : n === a ? 60 * (o - s) / u + 360 : o === a ? 60 * (s - n) / u + 120 : 60 * (n - o) / u + 240, i = 0 === d || 1 === d ? d : .5 >= d ? u / c : u / (2 - c), [Math.round(e) % 360, i, d, null == r ? 1 : r]
    ...
    function(t) {
        ...
        var o = /\+/g,
            s = t.cookie = function(o, r, a) {
                ...
                for (var c = s.raw ? e : i, d = document.cookie.split("; "), h = o ? void 0 : {}, f = 0, p = d.length; p > f; f++) {
                    var m = d[f].split("="),
                        v = c(m.shift()),
                        b = c(m.join("="));
                    if (o && o === v) {
    ...
    function(t) {
        t.fn.gridfire = function(e) {
            ...
            return this.initialize = function() {
                ...
                if (d.length > 0 && s.append(d), null != o.loadmore && (m = t('<div id="loadmore" class="notextselection" ></div>').appendTo(s).click(function() {
